...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng pencil = new LatLng(-6.2544282, 106.84);
        mMap.addMarker(new MarkerOptions().position(pencil).title("Jl. Pencil"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(pencil));
    }
}
